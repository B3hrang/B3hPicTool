...
export const ToolsPanel = () => {
    ...
    return (
        <div className="w-64 bg-secondary/50 border-r border-zinc-700 flex flex-col h-full z-10 backdrop-blur-sm">
            <div className="h-10 flex items-center px-4 border-b border-zinc-700 bg-secondary/50">
                <span className="text-xs font-bold uppercase tracking-wider text-zinc-500">
                    {activeToolsTab === 'upscale' ? 'Upscale Settings' : 'Remove BG'}
                </span>
            </div>
