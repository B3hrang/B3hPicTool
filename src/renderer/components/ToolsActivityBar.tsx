...
export const ToolsActivityBar = () => {
    const { activeToolsTab, isToolsPanelOpen, setToolsTab } = useAppStore();
    ...
    return (
        <div className="w-12 bg-secondary/80 border-r border-zinc-900 flex flex-col items-center py-4 gap-4 z-20">
            ...
            <div className="relative group w-full flex justify-center">
                <button
                    onClick={() => setToolsTab('upscale')}
                    className={clsx(
                        "p-2 rounded-md transition-all",
                        activeToolsTab === 'upscale' && isToolsPanelOpen
            ...
            <div className="relative group w-full flex justify-center">
                <button
                    onClick={() => setToolsTab('removebg')}
                    className={clsx(
                        "p-2 rounded-md transition-all",
                        activeToolsTab === 'removebg' && isToolsPanelOpen
                            ? "bg-accent/20 text-accent"
                            : "text-zinc-500 hover:text-zinc-200"
                    )}
